...
def build_judge_system_prompt() -> str:
    return (
        ...
        "diagnosis, strategy_guidance, capability_gap, preferred_capability_ids, "
        ...
        "Set capability_gap when the workflow lacks a capability abstraction, and preferred_capability_ids to rank registry capabilities. "
...
def build_subgraph_planner_system_prompt() -> str:
    return (
        ...
        "tool_call, clarification, verification, verification_step, capability_diagnosis, capability_extension, aggregate_results, evidence_synthesis, "
